...
#
# html_sidebars = {}
html_logo = './image/Scopy.png'

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'Scopydoc'
...
latex_documents = [
    (master_doc, 'Scopy.tex', 'Scopy Documentation',
     'Zhijiang Yang', 'manual'),
]
...
man_pages = [
    (master_doc, 'scopy', 'Scopy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Scopy', 'Scopy Documentation',
     author, 'Scopy', 'One line description of project.',
     'Miscellaneous'),
]
