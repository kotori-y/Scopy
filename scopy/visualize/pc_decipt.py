...
def oral_absorption_radar(mol):
    """Representing an oral absorption estimation.
    The compounds values are materialized by the blue line, 
    which should fall within the optimal green area.
    The rule from `fafdrugs4`_.
    
    :param mol: molecular
    :type mol: rdkit.Chem.rdchem.Mol
    :return: A radar plot representing an oral absorption estimation
    :rtype: matplotlib.figure.Figure
...
def pfizer_positioning(mol=None, PfizerRule=None):
    """
    """
    if mol:
