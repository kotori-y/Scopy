...
class PC_rules(object):
    ...
    def CheckEganRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckEganRule, detail=self.detail)
        pool = Pool(self.n_jobs)
    ...
    def CheckVeberRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckVeberRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckLipinskiRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckLipinskiRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckBeyondRo5(self):
        ...
        """
        fn = partial(rulesfilter.CheckBeyondRo5, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckPfizerRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckPfizerRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckGSKRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckGSKRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckOralMacrocycles(self):
        ...
        """
        fn = partial(rulesfilter.CheckOralMacrocycles, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckOpreaRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckOpreaRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckGhoseRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckGhoseRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckREOS(self):
        ...
        """
        fn = partial(rulesfilter.CheckREOS, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckGoldenTriangle(self):
        ...
        """
        pass
#        fn = partial(rulesfilter.CheckGoldenTriangle, detail=self.detail)
#        pool = Pool(self.n_jobs)
#        res = pool.map_async(fn, self.mols).get()
#        pool.close()
#        pool.join()
#        return res  
    ...
    def CheckXuRule(self):
        ...
        """
        fn = partial(rulesfilter.CheckXuRule, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckRo4(self):
        ...
        """
        fn = partial(rulesfilter.CheckRo4, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckRo3(self):
        ...
        """
        fn = partial(rulesfilter.CheckRo3, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckRo2(self):
        ...
        """
        fn = partial(rulesfilter.CheckRo2, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckCNS(self):
        ...
        """
        fn = partial(rulesfilter.CheckCNS, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
    ...
    def CheckRespiratory(self):
        ...
        """
        fn = partial(rulesfilter.CheckRespiratory, detail=self.detail)
        pool = Pool(self.n_jobs)
        res = pool.map_async(fn, self.mols).get()
        pool.close()
        pool.join()
